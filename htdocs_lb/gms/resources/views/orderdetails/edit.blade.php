...
<body>
	<div class="container">
		...
		<h1>Edit {{ $orderdetail->id }}</h1>
		<!-- if there are creation errors, they will show here -->
		{{ HTML::ul($errors->all()) }}
		{{ Form::model($orderdetail, array('route' => array('orderdetails.update', $orderdetail->detailid), 'method' => 'PUT')) }}
		...
		<div class="form-group">
			...
			{{ Form::text('orderid', Input::old('orderid'),
			array('class' => 'form-control')) }}
		</div>
